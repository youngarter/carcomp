    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10">
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
                <div className="bg-white rounded-2xl sm:rounded-[3rem] p-6 sm:p-10 shadow-[0_15px_40px_rgba(0,0,0,0.03)] border border-zinc-100 flex flex-col items-center justify-center text-center">
                    <h3 className="text-sm font-black text-zinc-900 uppercase tracking-[0.2em] mb-6 sm:mb-8">Note globale</h3>

                    <span className="text-5xl sm:text-7xl font-black text-zinc-900 tracking-tighter tabular-nums mb-4">{averageRating} <span className="text-xl sm:text-2xl text-zinc-400">/5</span></span>
                ...
                <div className="bg-emerald-50 rounded-2xl sm:rounded-[3rem] p-6 sm:p-10 border border-emerald-100/50">
            ...
            <div className="lg:col-span-8 flex flex-col">
                <div className="bg-white rounded-2xl sm:rounded-[3rem] p-6 sm:p-10 shadow-[0_15px_40px_rgba(0,0,0,0.03)] border border-zinc-100 h-full">
