    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 flex flex-col gap-8">
                {/* Score Card */}
                <div className="bg-white rounded-[3rem] p-10 shadow-[0_15px_40px_rgba(0,0,0,0.03)] border border-zinc-100 flex flex-col items-center justify-center text-center relative overflow-hidden">
                    ...
                    <div className="relative mb-6">
                        <div className="w-40 h-40 rounded-full border-[12px] border-zinc-50 flex items-center justify-center relative z-10 bg-white shadow-inner">
                            <span className="text-6xl font-black text-zinc-900 tracking-tighter tabular-nums">{aiScore.toFixed(1)}</span>
                            <span className="text-xl font-bold text-zinc-400 absolute bottom-6 right-8">/10</span>
                        </div>
                    </div>
                </div>
            ...
            <div className="lg:col-span-7 flex flex-col gap-8">
                {/* Scoring Bars */}
                <div className="bg-white rounded-[3rem] p-10 shadow-[0_15px_40px_rgba(0,0,0,0.03)] border border-zinc-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white rounded-[2.5rem] p-8 shadow-[0_15px_40px_rgba(0,0,0,0.03)] border border-zinc-100">
                ...
                {/* Recommended For */}
                <div className="bg-zinc-900 rounded-[2.5rem] p-8 shadow-[0_15px_40px_rgba(0,0,0,0.1)] border border-zinc-800">
